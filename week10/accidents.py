    ...
    try:
        ...
        with open(filename, "rt") as text_file:
            while True:
                ...
                if perc_reduc < 0:
                    print("Your number is less than zero, please try again.")
                elif perc_reduc > 100:
        ...
        print(f"The file {filename} does not have the correct permissions to read.")
        ...
        print()
        print(type(zero_div).__name__, zero_div, sep=": ")
        print("The program attempted to divide by zero.")
        print(f"Your filename is: {filename}")
    except csv.Error as csv_error:
        print()
        print(type(csv_error).__name__, csv_error, sep=": ")
        print(f"The filename, {filename}, is invalid. Please check your file and try again.")
